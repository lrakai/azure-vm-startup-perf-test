...
function Set-LabArtifacts {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/lrakai/azure-vm-startup-perf-test/master/src/bootstrap.ps1" -OutFile C:\Users\student\Desktop\bootstrap.ps1
    # Create backup
    $path = "C:\Scripts"
    if(!(Test-Path $path))
    {
    ...
    Invoke-WebRequest -Uri "https://raw.githubusercontent.com/lrakai/azure-vm-startup-perf-test/master/src/bootstrap.ps1" -OutFile $($path + "\" + "bootstrap.ps1")
